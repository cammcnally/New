...
> Current file: `docs/assessments/path-consistency-latest.md`
...
- Scope: Historical path contract review captured before the lifecycle migration
- Supersedes: none
- Superseded By: docs/assessments/path-consistency-latest.md
